...
SCORES_CSV_PATH = "./cartpole/scores/scores.csv"
SCORES_PNG_PATH = "./cartpole/scores/scores.png"
SOLVED_CSV_PATH = "./cartpole/scores/solved.csv"
SOLVED_PNG_PATH = "./cartpole/scores/solved.png"
